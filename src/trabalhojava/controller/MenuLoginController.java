...
import mostranomecomthreadsesockets.RunnableNomes;
...
public class MenuLoginController implements Initializable {
    ...
    public RunnableNomes runnableNomes;
    public Thread threadNomes;

    @Override
    public void initialize(URL url, ResourceBundle rb) {

        runnableNomes = new RunnableNomes(this.labelNomes);
        threadNomes = new Thread(runnableNomes);
    ...
    public void clicaButtonSair() {
        threadNomes.interrupt();
        //runnableNomes.infinito = false;
